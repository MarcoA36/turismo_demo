    ...
    return (
      <main className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <p className="text-center text-muted-foreground">Destino no encontrado</p>
        </div>
        <Footer />
      </main>
    )
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-5xl md:text-6xl font-bold mb-4 text-balance">{destination.name}</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-card-foreground">Sobre este destino</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">{destination.description}</p>
            </section>

            {/* Highlights */}
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-6 text-card-foreground">Atractivos principales</h2>
            ...
            {/* Practical info */}
            <section>
              <h2 className="text-3xl font-bold mb-6 text-card-foreground">Información práctica</h2>
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="p-6 bg-card rounded-lg border border-border">
                  <p className="text-sm text-muted-foreground mb-2">Mejor época para visitar</p>
                  <p className="text-2xl font-bold text-card-foreground">{destination.bestSeason}</p>
                </div>
                <div className="p-6 bg-card rounded-lg border border-border">
                  <p className="text-sm text-muted-foreground mb-2">Duración recomendada</p>
                  <p className="text-2xl font-bold text-card-foreground">{destination.duration}</p>
                </div>
              </div>
            </section>
          </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-card rounded-lg border border-border p-8">
              ...
              <div className="mb-8">
                ...
                <p className="text-5xl font-bold text-primary mb-2">${destination.price}</p>
              ...
              <div className="mb-8 pb-8 border-b border-border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-lg text-card-foreground">{destination.rating}</p>
              ...
              <div className="mt-8 pt-8 border-t border-border space-y-4">
                ...
                <div className="flex items-center gap-3">
                  <Calendar className="w-5 h-5 text-primary" />
                  <span className="text-sm text-muted-foreground">{destination.bestSeason}</span>
                </div>
                <div className="flex items-center gap-3">
        ...
        <section className="mt-20 pt-12 border-t border-border">
          <h2 className="text-3xl font-bold mb-8 text-card-foreground">Otros destinos</h2>
              ...
              .map((dest) => (
                ...
                >
                  ...
                  <div className="p-4 bg-card">
                    <h3 className="font-bold text-card-foreground">{dest.name}</h3>
